...
export const lightColors = {
  ...
  primaryLight: '#FFD199',
  accent: '#EE8C2B',
  /** Text/icons drawn on accent fills (always light for contrast). */
  onAccent: '#FFFFFF',
  ...
  /** Floating tab island frosted fill (opaque enough to stay readable without live backdrop blur). */
  tabBarGlass: 'rgba(232, 230, 228, 0.94)',
  /** Light rim on the glass tab island. */
  tabBarGlassBorder: 'rgba(255, 255, 255, 0.55)',
...
export const darkColors = {
  ...
  /** Floating tab island frosted fill (opaque enough to stay readable without live backdrop blur). */
  tabBarGlass: 'rgba(14, 20, 29, 0.92)',
  tabBarGlassBorder: 'rgba(255, 255, 255, 0.14)',
