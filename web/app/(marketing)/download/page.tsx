...
export const metadata: Metadata = {
  title: "Download",
  description: "Get Pawsoul on iOS and Android: free tier available.",
};
  ...
  return (
    <div className="py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-stone-900 dark:text-stone-50">Download Pawsoul</h1>
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="flex items-center justify-center">
            <AppPhoneMockup
              ...
              alt="Pawsoul app home screen in light mode on a phone"
              size="xl"
              float={false}
            />
          </div>
