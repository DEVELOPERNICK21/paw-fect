      ...
      <article className="prose prose-stone mx-auto max-w-3xl px-4 dark:prose-invert sm:px-6 lg:px-8">
        ...
        <ol>
          ...
          <li>
            ...
            <strong>registered email address or phone number</strong> (the one
            you use to sign in) so we can verify ownership.
          </li>
        </ol>
        <p>
          We may ask a short follow-up to confirm identity before processing.
          For general help (not deletion), you can also use{' '}
          <Link
            href="/contact"
            className="text-stone-700 underline dark:text-stone-300"
          >
        ...
        <ul>
          ...
          <li>
            Pet profiles, schedules, and health records stored for that account
            (vaccination and deworming logs, notes, and related data you added).
          </li>
        </ul>
        ...
        <ul>
          <li>
            We aim to complete deletion of personal and pet health data within{' '}
            <strong>30 days</strong> of a verified request, consistent with our{' '}
            <Link
              href="/privacy"
              className="text-stone-700 underline dark:text-stone-300"
            >
          ...
          <li>
            We may retain certain information longer where required by law, tax,
            or accounting rules, or for legitimate security and fraud-prevention
            (for example, minimal transaction or abuse-prevention records). Such
            data is not used for marketing after account closure.
          </li>
        </ul>
