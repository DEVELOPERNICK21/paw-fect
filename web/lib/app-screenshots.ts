...
export const appGalleryScreenshots: readonly AppScreenshot[] = [
  ...
  },
  {
    id: "home-dark-2",
    src: shot213000,
    alt: "Pawfect home screen with pet selector and current status card",
    label: "Dashboard",
  },
  {
    id: "alerts",
    src: shot213013,
    alt: "Pawfect home with health reminders and attention banner",
    label: "Reminders",
  },
  {
    id: "home-light",
  ...
  },
  {
    id: "care-actions",
    src: shot213025,
    alt: "Pawfect quick actions and today care sections",
    label: "Care & actions",
  },
  {
    id: "profile-hero",
    src: shot212941,
    alt: "Pawfect pet profile with photo and details",
    label: "Pet profile",
  },
  {
    id: "profile-stats",
    src: shot213029,
    alt: "Pawfect pet profile with weight and stats",
    label: "Profile details",
  },
  {
    id: "notifications",
    src: shot213032,
    alt: "Pawfect notifications screen",
    label: "Notifications",
  },
] as const;
